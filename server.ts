...
async function startServer() {
  ...
  app.post("/api/chat", async (req, res) => {
    try {
      const { message, history, habits, goals } = req.body;
      ...
      const systemInstruction = 
        "Eres un coach experto personalizado sumamente sabio y motivador, especialista en todos los hábitos y metas del usuario.\n\n" +
        ...
        "3. LÍMITE DE LONGITUD DE RESPUESTA: Responde en un MÁXIMO absoluto de DOS (2) párrafos de texto. Tus respuestas deben ser sumamente memorables, concisas e incentivar la acción. Nunca superes los dos párrafos.\n" +
